...
def test_normalize_ap_properties():
    ...
    assert abs(norm1 - norm2) < 0.01, "Similar effect sizes should have similar normalized scores"
...
def test_normalization_interpretability():
    ...
    assert abs(normalized[random_idx]) < 0.1, "Near-random performance should normalize near 0"
